...
class AF1Page extends StatefulWidget {
  const AF1Page({super.key});

  @override
  _AF1PageState createState() => _AF1PageState();
}

class _AF1PageState extends State<AF1Page> { 
  String? selectedSize = '6'; 
  int quantity = 1; 

  Future<void> _addToCart() async { // Add item to shopping cart.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Nike Air Force 1', style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: Colors.grey.shade900,
          ...
          child: Column(
            ...
            children: [
              ...
              const Text( // Description
                "Stand tall in the style stakes with these men's Nike Air Force 1 Lo trainers!" "\n" 
                "An instant icon ever since 1982, the AF1 was Nike's first basketball shoe with a full length Air Sole unit in the midsole." "\n"
                "Hugely popular on the hip hop scene, these Nike Air Force 1 trainers are built with a crisp white leather upper for hard-wearing comfort." "\n" 
                "Sat atop the legendary Air Sole unit for optimum impact protection step after step, pivot points to the outsole deliver smooth movements from the courts to the streets," 
              ...
              Navigator.push(
                ...
                PageRouteBuilder(
                  ...
                  transitionsBuilder: (context, animation, secondaryAnimation, child) {
                    ...
                    return SlideTransition(position: offsetAnimation, child: child);  // Transition Up
                  },
                ),
              );
            }
