...
class CWS_Page extends StatefulWidget {
  const CWS_Page({super.key});

  @override
  _CWS_PageState createState() => _CWS_PageState();
}

class _CWS_PageState extends State<CWS_Page> {
  String? selectedSize = 'XS'; 
  int quantity = 1; 

  Future<void> _addToCart() async { // Links to Database
      final dbHelper = DatabaseHelper();

      Map<String, dynamic> item = { // Creates a Map
        'productName': 'Chicago White Sox Cap',
        'size': selectedSize,
        'quantity': quantity,
        'price': 24.73,
      };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Chicago White Sox Cap', style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: Colors.grey.shade900,
          ...
          child: Column(
            ...
            children: [
              ...
              const Text( // Description
                "With classic Chicago White Sox team logo embroidered (raised) on front.\nMLB Batterman logo on back.\n2005 World Series patch embroidered on left side.\nGrey undervisor and white sweatband.\nClassic 59FIFTY fit with a high structured crown and flat visor.\nWith stitched eyelets for breathability.\nInterior includes branded taping.",
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8.0),
                      DropdownButton<String>( // Drop DOwn
                        hint: const Text(
                          'Choose size',
