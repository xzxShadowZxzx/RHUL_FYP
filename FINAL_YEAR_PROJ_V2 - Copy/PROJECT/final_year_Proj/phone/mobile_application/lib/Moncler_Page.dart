...
class Moncler_Page extends StatefulWidget {
  const Moncler_Page({super.key});

  @override
  _MonclerPageState createState() => _MonclerPageState();
}

class _MonclerPageState extends State<Moncler_Page> { 
  ...
  Future<void> _addToCart() async {
      ...
      Map<String, dynamic> item = { // Creates Map of the product
        'productName': 'Moncler Ducky T-Shirt',
        'size': selectedSize,
        'quantity': quantity,
        'price': 90,
      };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Moncler Ducky T-Shirt', style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: Colors.grey.shade900,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text( // Desc
                "Moncler showcases a playful and tongue-in-cheek take on the Italian brand's iconic outerwear DNA with this unique black tee.\nThis t-shirt is characterized by cartoon-style ducks proudly wearing multicolored quilted jackets, adding a touch of whimsy and character to your wardrobe.",
