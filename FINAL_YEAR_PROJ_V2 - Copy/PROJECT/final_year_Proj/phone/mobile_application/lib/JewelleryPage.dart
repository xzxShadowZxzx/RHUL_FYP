...
class Jewellerypage extends StatelessWidget {
  ...
  final List<Map<String, String>> jewellerys = const [ // Map of the products.
    {'name': '14k Golden Ring', 'image': 'assets/14K_ring.webp', 'price': '£999'},
    {'name': '24K Golden Chain', 'image': 'assets/gold_chain.png', 'price': '£2099'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Jewellery', style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: Colors.grey.shade900,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          if (jewellery['name'] == '24K Golden Chain') {
                            Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const Chain_Page()),
                            );
                          }

                          if (jewellery['name'] == '14k Golden Ring') {
                            Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const Ring_Page()),
                            );
                          }
